...
//   At: 2025-03-06T09:30:55.7178777+01:00
//
...
public partial class BinarySensorEntities
{
    ...
    ///<summary>Droger Cloud connection</summary>
    public BinarySensorEntity DrogerCloudConnection => new(_haContext, "binary_sensor.droger_cloud_connection");
    ///<summary>Droger Overheated</summary>
    public BinarySensorEntity DrogerOverheated => new(_haContext, "binary_sensor.droger_overheated");
    ///<summary>Droger Overloaded</summary>
    public BinarySensorEntity DrogerOverloaded => new(_haContext, "binary_sensor.droger_overloaded");
    ...
    ///<summary>Garage Overheated</summary>
    public BinarySensorEntity GarageOverheated => new(_haContext, "binary_sensor.garage_overheated");
    ///<summary>Garage Overloaded</summary>
    public BinarySensorEntity GarageOverloaded => new(_haContext, "binary_sensor.garage_overloaded");
    ///<summary>Kantoor Cloud connection</summary>
    public BinarySensorEntity KantoorCloudConnection => new(_haContext, "binary_sensor.kantoor_cloud_connection");
    ///<summary>Kantoor Overheated</summary>
    public BinarySensorEntity KantoorOverheated => new(_haContext, "binary_sensor.kantoor_overheated");
    ///<summary>Kantoor Overloaded</summary>
    public BinarySensorEntity KantoorOverloaded => new(_haContext, "binary_sensor.kantoor_overloaded");
...
public partial class NumberEntities
{
    ...
    ///<summary>Audio Power protection</summary>
    ...
    ///<summary>Computer Power protection</summary>
    ...
    ///<summary>Droger Power protection</summary>
    public NumberEntity DrogerPowerProtection => new(_haContext, "number.droger_power_protection");
    ///<summary>Droger Turn off in</summary>
    public NumberEntity DrogerTurnOffIn => new(_haContext, "number.droger_turn_off_in");
    ...
    ///<summary>Garage Power protection</summary>
    ...
    ///<summary>Kantoor Power protection</summary>
    public NumberEntity KantoorPowerProtection => new(_haContext, "number.kantoor_power_protection");
    ///<summary>Kantoor Turn off in</summary>
    public NumberEntity KantoorTurnOffIn => new(_haContext, "number.kantoor_turn_off_in");
    ...
    ///<summary>Spotjes Verlichting Power protection</summary>
    ...
    ///<summary>Tuinhuis verlichting  Power protection</summary>
    ...
    ///<summary>TV en Media Power protection</summary>
    ...
    ///<summary>Vaatwasser  Power protection</summary>
    ...
    ///<summary>Wasmachine  Power protection</summary>
...
public partial class SensorEntities
{
    ...
    ///<summary>Droger Auto off at</summary>
    public SensorEntity DrogerAutoOffAt => new(_haContext, "sensor.droger_auto_off_at");
    ///<summary>Droger Signaalniveau</summary>
    public SensorEntity DrogerSignaalniveau => new(_haContext, "sensor.droger_signaalniveau");
    ...
    ///<summary>Kantoor Auto off at</summary>
    public SensorEntity KantoorAutoOffAt => new(_haContext, "sensor.kantoor_auto_off_at");
    ///<summary>Kantoor Signaalniveau</summary>
    public SensorEntity KantoorSignaalniveau => new(_haContext, "sensor.kantoor_signaalniveau");
    ...
    ///<summary>Q7 Max Total cleaning count</summary>
    public SensorEntity Q7MaxTotalCleaningCount => new(_haContext, "sensor.q7_max_total_cleaning_count");
    ...
    public NumericSensorEntity AveragePrice => new(_haContext, "sensor.average_price");
    ...
    public NumericSensorEntity CurrentPrice => new(_haContext, "sensor.current_price");
    ///<summary>Deurbel Wireless</summary>
    public NumericSensorEntity DeurbelWireless => new(_haContext, "sensor.deurbel_wireless");
    ///<summary>Droger Huidig gebruik</summary>
    public NumericSensorEntity DrogerHuidigGebruik => new(_haContext, "sensor.droger_huidig_gebruik");
    ///<summary>Droger Spanning</summary>
    public NumericSensorEntity DrogerSpanning => new(_haContext, "sensor.droger_spanning");
    ///<summary>Droger Stroom</summary>
    public NumericSensorEntity DrogerStroom => new(_haContext, "sensor.droger_stroom");
    ///<summary>Droger This month&apos;s consumption</summary>
    public NumericSensorEntity DrogerThisMonthSConsumption => new(_haContext, "sensor.droger_this_month_s_consumption");
    ///<summary>Droger Today&apos;s consumption</summary>
    public NumericSensorEntity DrogerTodaySConsumption => new(_haContext, "sensor.droger_today_s_consumption");
    ...
    ///<summary>Kantoor Huidig gebruik</summary>
    public NumericSensorEntity KantoorHuidigGebruik => new(_haContext, "sensor.kantoor_huidig_gebruik");
    ///<summary>Kantoor Spanning</summary>
    public NumericSensorEntity KantoorSpanning => new(_haContext, "sensor.kantoor_spanning");
    ///<summary>Kantoor Stroom</summary>
    public NumericSensorEntity KantoorStroom => new(_haContext, "sensor.kantoor_stroom");
    ///<summary>Kantoor This month&apos;s consumption</summary>
    public NumericSensorEntity KantoorThisMonthSConsumption => new(_haContext, "sensor.kantoor_this_month_s_consumption");
    ///<summary>Kantoor Today&apos;s consumption</summary>
    public NumericSensorEntity KantoorTodaySConsumption => new(_haContext, "sensor.kantoor_today_s_consumption");
...
public partial class SwitchEntities
{
    ...
    ///<summary>Droger Auto off enabled</summary>
    public SwitchEntity DrogerAutoOffEnabled => new(_haContext, "switch.droger_auto_off_enabled");
    ///<summary>Droger Auto update enabled</summary>
    public SwitchEntity DrogerAutoUpdateEnabled => new(_haContext, "switch.droger_auto_update_enabled");
    ///<summary>Droger LED</summary>
    public SwitchEntity DrogerLed => new(_haContext, "switch.droger_led");
    ...
    ///<summary>Kantoor Auto off enabled</summary>
    public SwitchEntity KantoorAutoOffEnabled => new(_haContext, "switch.kantoor_auto_off_enabled");
    ///<summary>Kantoor Auto update enabled</summary>
    public SwitchEntity KantoorAutoUpdateEnabled => new(_haContext, "switch.kantoor_auto_update_enabled");
    ///<summary>Kantoor LED</summary>
    public SwitchEntity KantoorLed => new(_haContext, "switch.kantoor_led");
...
public partial class UpdateEntities
{
    ...
    ///<summary>Material You and Material Rounded - Material Design 3 Themes update</summary>
...
public partial class ScheduleServices
{
    ...
    ///<summary>Retrieve one or multiple schedules.</summary>
    ///<param name="target">The target for this service call</param>
