...
//   At: 2025-01-14T21:21:06.0506977+01:00
//
...
public static class GeneratedExtensions
{
    ...
    public static IServiceCollection AddHomeAssistantGenerated(this IServiceCollection serviceCollection)
    {
        ...
        serviceCollection.AddTransient<EntsoeServices>();
...
public partial class AutomationEntities
{
    ...
    ///<summary>TV Sound Move Mode</summary>
    ...
    ///<summary>Verlichting aan bij zonsondergang</summary>
    public AutomationEntity VerlichtingAanBijZonsondergang => new(_haContext, "automation.verlichting_aan_bij_zonsondergang");
}
...
public partial class BinarySensorEntities
{
    ...
    ///<summary>Audio Overheat</summary>
    public BinarySensorEntity AmplifierOverheat => new(_haContext, "binary_sensor.amplifier_overheat");
    ...
    ///<summary>Droger Overheat</summary>
    public BinarySensorEntity DrogerOverheat => new(_haContext, "binary_sensor.droger_overheat");
    ...
    ///<summary>Spotjes Verlichting Overheat</summary>
    ...
    ///<summary>TV en Media Overheat</summary>
    public BinarySensorEntity TvEnMediaOverheat => new(_haContext, "binary_sensor.tv_en_media_overheat");
    ///<summary>Vaatwasser  Overheat</summary>
    public BinarySensorEntity VaatwasserOverheat => new(_haContext, "binary_sensor.vaatwasser_overheat");
    ...
    ///<summary>Wasmachine  Overheat</summary>
    public BinarySensorEntity WasmachineOverheat => new(_haContext, "binary_sensor.wasmachine_overheat");
...
public partial class ButtonEntities
{
    ...
    public ButtonEntity OfficeHerstarten => new(_haContext, "button.office_herstarten");
    ///<summary>Sync time</summary>
    public ButtonEntity OfficeSyncTime => new(_haContext, "button.office_sync_time");
...
public partial class ClimateEntities
{
    ...
    ///<summary>AC-Zolder</summary>
    public ClimateEntity AcZolder => new(_haContext, "climate.ac_zolder");
...
public partial class InputBooleanEntities
{
    ...
    ///<summary>netdaemon_net_daemon_apps_apps_adjust_power_schedule_adjust_energy_schedule</summary>
    public InputBooleanEntity NetdaemonNetDaemonAppsAppsAdjustPowerScheduleAdjustEnergySchedule => new(_haContext, "input_boolean.netdaemon_net_daemon_apps_apps_adjust_power_schedule_adjust_energy_schedule");
    ///<summary>netdaemon_net_daemon_apps_apps_vacation_alarm_vacation_alarm</summary>
    public InputBooleanEntity NetdaemonNetDaemonAppsAppsVacationAlarmVacationAlarm => new(_haContext, "input_boolean.netdaemon_net_daemon_apps_apps_vacation_alarm_vacation_alarm");
}
...
public partial class SelectEntities
{
    ...
    ///<summary>Q7 Max Selected map</summary>
    public SelectEntity Q7MaxSelectedMap => new(_haContext, "select.q7_max_selected_map");
...
public partial class SensorEntities
{
    ...
    ///<summary>Time of highest price (energy_prices)</summary>
    public SensorEntity EnergyPricesTimeOfHighestPrice => new(_haContext, "sensor.energy_prices_time_of_highest_price");
    ///<summary>Time of lowest price (energy_prices)</summary>
    public SensorEntity EnergyPricesTimeOfLowestPrice => new(_haContext, "sensor.energy_prices_time_of_lowest_price");
    ...
    ///<summary>Q7 Max Dock error</summary>
    public SensorEntity Q7MaxDockError => new(_haContext, "sensor.q7_max_dock_error");
    ...
    ///<summary>Q7 Max Vacuum error</summary>
    public SensorEntity Q7MaxVacuumError => new(_haContext, "sensor.q7_max_vacuum_error");
    ...
    ///<summary>Audio Current Power</summary>
    public NumericSensorEntity AmplifierCurrentPower => new(_haContext, "sensor.amplifier_current_power");
    ///<summary>Audio Month Energy</summary>
    public NumericSensorEntity AmplifierMonthEnergy => new(_haContext, "sensor.amplifier_month_energy");
    ///<summary>Audio Month Runtime</summary>
    public NumericSensorEntity AmplifierMonthRuntime => new(_haContext, "sensor.amplifier_month_runtime");
    ///<summary>Audio Signal Level</summary>
    public NumericSensorEntity AmplifierSignalLevel => new(_haContext, "sensor.amplifier_signal_level");
    ///<summary>Audio Today Energy</summary>
    public NumericSensorEntity AmplifierTodayEnergy => new(_haContext, "sensor.amplifier_today_energy");
    ///<summary>Audio Today Runtime</summary>
    public NumericSensorEntity AmplifierTodayRuntime => new(_haContext, "sensor.amplifier_today_runtime");
    ...
    ///<summary>Droger Current Power</summary>
    public NumericSensorEntity DrogerCurrentPower => new(_haContext, "sensor.droger_current_power");
    ///<summary>Droger Month Energy</summary>
    public NumericSensorEntity DrogerMonthEnergy => new(_haContext, "sensor.droger_month_energy");
    ///<summary>Droger Month Runtime</summary>
    public NumericSensorEntity DrogerMonthRuntime => new(_haContext, "sensor.droger_month_runtime");
    ///<summary>Droger Signal Level</summary>
    public NumericSensorEntity DrogerSignalLevel => new(_haContext, "sensor.droger_signal_level");
    ///<summary>Droger Today Energy</summary>
    public NumericSensorEntity DrogerTodayEnergy => new(_haContext, "sensor.droger_today_energy");
    ///<summary>Droger Today Runtime</summary>
    public NumericSensorEntity DrogerTodayRuntime => new(_haContext, "sensor.droger_today_runtime");
    ...
    ///<summary>Average electricity price (energy_prices)</summary>
    public NumericSensorEntity EnergyPricesAverageElectricityPrice => new(_haContext, "sensor.energy_prices_average_electricity_price");
    ///<summary>Current electricity market price (energy_prices)</summary>
    ...
    ///<summary>Current percentage in electricity price range (energy_prices)</summary>
    public NumericSensorEntity EnergyPricesCurrentPercentageInElectricityPriceRange => new(_haContext, "sensor.energy_prices_current_percentage_in_electricity_price_range");
    ///<summary>Current percentage of highest electricity price (energy_prices)</summary>
    public NumericSensorEntity EnergyPricesCurrentPercentageOfHighestElectricityPrice => new(_haContext, "sensor.energy_prices_current_percentage_of_highest_electricity_price");
    ///<summary>Highest energy price (energy_prices)</summary>
    public NumericSensorEntity EnergyPricesHighestEnergyPrice => new(_haContext, "sensor.energy_prices_highest_energy_price");
    ///<summary>Lowest energy price (energy_prices)</summary>
    public NumericSensorEntity EnergyPricesLowestEnergyPrice => new(_haContext, "sensor.energy_prices_lowest_energy_price");
    ///<summary>Next hour electricity market price (energy_prices)</summary>
    ...
    ///<summary>nordpool_kwh_nl_eur_3_10_021</summary>
    public NumericSensorEntity NordpoolKwhNlEur310021 => new(_haContext, "sensor.nordpool_kwh_nl_eur_3_10_021");
    ...
    ///<summary>Q7 Max Cleaning time</summary>
    public NumericSensorEntity Q7MaxCleaningTime => new(_haContext, "sensor.q7_max_cleaning_time");
    ///<summary>Q7 Max Filter time left</summary>
    public NumericSensorEntity Q7MaxFilterTimeLeft => new(_haContext, "sensor.q7_max_filter_time_left");
    ///<summary>Q7 Max Main brush time left</summary>
    public NumericSensorEntity Q7MaxMainBrushTimeLeft => new(_haContext, "sensor.q7_max_main_brush_time_left");
    ...
    ///<summary>Q7 Max Sensor time left</summary>
    public NumericSensorEntity Q7MaxSensorTimeLeft => new(_haContext, "sensor.q7_max_sensor_time_left");
    ///<summary>Q7 Max Side brush time left</summary>
    public NumericSensorEntity Q7MaxSideBrushTimeLeft => new(_haContext, "sensor.q7_max_side_brush_time_left");
    ...
    ///<summary>Q7 Max Total cleaning time</summary>
    public NumericSensorEntity Q7MaxTotalCleaningTime => new(_haContext, "sensor.q7_max_total_cleaning_time");
    ...
    ///<summary>TV en Media Current Power</summary>
    public NumericSensorEntity TvEnMediaCurrentPower => new(_haContext, "sensor.tv_en_media_current_power");
    ///<summary>TV en Media Month Energy</summary>
    public NumericSensorEntity TvEnMediaMonthEnergy => new(_haContext, "sensor.tv_en_media_month_energy");
    ///<summary>TV en Media Month Runtime</summary>
    public NumericSensorEntity TvEnMediaMonthRuntime => new(_haContext, "sensor.tv_en_media_month_runtime");
    ///<summary>TV en Media Signal Level</summary>
    public NumericSensorEntity TvEnMediaSignalLevel => new(_haContext, "sensor.tv_en_media_signal_level");
    ///<summary>TV en Media Today Energy</summary>
    public NumericSensorEntity TvEnMediaTodayEnergy => new(_haContext, "sensor.tv_en_media_today_energy");
    ///<summary>TV en Media Today Runtime</summary>
    public NumericSensorEntity TvEnMediaTodayRuntime => new(_haContext, "sensor.tv_en_media_today_runtime");
    ///<summary>Vaatwasser  Current Power</summary>
    public NumericSensorEntity VaatwasserCurrentPower => new(_haContext, "sensor.vaatwasser_current_power");
    ///<summary>Vaatwasser  Month Energy</summary>
    public NumericSensorEntity VaatwasserMonthEnergy => new(_haContext, "sensor.vaatwasser_month_energy");
    ///<summary>Vaatwasser  Month Runtime</summary>
    public NumericSensorEntity VaatwasserMonthRuntime => new(_haContext, "sensor.vaatwasser_month_runtime");
    ///<summary>Vaatwasser  Signal Level</summary>
    public NumericSensorEntity VaatwasserSignalLevel => new(_haContext, "sensor.vaatwasser_signal_level");
    ///<summary>Vaatwasser  Today Energy</summary>
    public NumericSensorEntity VaatwasserTodayEnergy => new(_haContext, "sensor.vaatwasser_today_energy");
    ///<summary>Vaatwasser  Today Runtime</summary>
    public NumericSensorEntity VaatwasserTodayRuntime => new(_haContext, "sensor.vaatwasser_today_runtime");
    ...
    ///<summary>Wasmachine  Current Power</summary>
    public NumericSensorEntity WasmachineCurrentPower => new(_haContext, "sensor.wasmachine_current_power");
    ///<summary>Wasmachine  Month Energy</summary>
    public NumericSensorEntity WasmachineMonthEnergy => new(_haContext, "sensor.wasmachine_month_energy");
    ///<summary>Wasmachine  Month Runtime</summary>
    public NumericSensorEntity WasmachineMonthRuntime => new(_haContext, "sensor.wasmachine_month_runtime");
    ///<summary>Wasmachine  Signal Level</summary>
    public NumericSensorEntity WasmachineSignalLevel => new(_haContext, "sensor.wasmachine_signal_level");
    ///<summary>Wasmachine  Today Energy</summary>
    public NumericSensorEntity WasmachineTodayEnergy => new(_haContext, "sensor.wasmachine_today_energy");
    ///<summary>Wasmachine  Today Runtime</summary>
    public NumericSensorEntity WasmachineTodayRuntime => new(_haContext, "sensor.wasmachine_today_runtime");
...
public partial class SwitchEntities
{
    ...
    public SwitchEntity Amplifier => new(_haContext, "switch.amplifier");
    ...
    public SwitchEntity Droger => new(_haContext, "switch.droger");
    ...
    ///<summary>Q7 Max Kinderslot</summary>
    public SwitchEntity Q7MaxKinderslot => new(_haContext, "switch.q7_max_kinderslot");
    ...
    ///<summary>Tuin Motion detection</summary>
    ...
    ///<summary>Voordeur Motion detection</summary>
    ...
    ///<summary>Woonkamer Motion detection</summary>
...
public partial class UpdateEntities
{
    ...
    ///<summary>Audio Firmware</summary>
    public UpdateEntity AmplifierFirmware => new(_haContext, "update.amplifier_firmware");
    ...
    ///<summary>Dreo Smart Device Integration update</summary>
    public UpdateEntity DreoSmartDeviceIntegrationUpdate => new(_haContext, "update.dreo_smart_device_integration_update");
    ///<summary>Droger Firmware</summary>
    public UpdateEntity DrogerFirmware => new(_haContext, "update.droger_firmware");
    ///<summary>Duck DNS Update</summary>
    public UpdateEntity DuckDnsUpdate => new(_haContext, "update.duck_dns_update");
    ///<summary>ENTSO-e Transparency Platform update</summary>
    public UpdateEntity EntsoETransparencyPlatformUpdate => new(_haContext, "update.entso_e_transparency_platform_update");
    ...
    ///<summary>Spotjes Verlichting Firmware</summary>
    ...
    ///<summary>Material Rounded and Material You - Material Design 3 Themes update</summary>
    ...
    ///<summary>Tapo Controller update</summary>
    public UpdateEntity TapoControllerUpdate => new(_haContext, "update.tapo_controller_update");
    ...
    ///<summary>TV en Media Firmware</summary>
    public UpdateEntity TvEnMediaFirmware => new(_haContext, "update.tv_en_media_firmware");
    ///<summary>Vaatwasser  Firmware</summary>
    public UpdateEntity VaatwasserFirmware => new(_haContext, "update.vaatwasser_firmware");
    ///<summary>Wasmachine  Firmware</summary>
    public UpdateEntity WasmachineFirmware => new(_haContext, "update.wasmachine_firmware");
}
...
public partial record DatetimeAttributes
{
    ...
    public object? ManualCoolingStartDateTime { get; init; }

    [JsonPropertyName("manual_cooling_end_date_time")]
    public object? ManualCoolingEndDateTime { get; init; }

    [JsonPropertyName("manual_cooling_days_remaining")]
    public object? ManualCoolingDaysRemaining { get; init; }
}
...
public partial class Services : IServices
{
    ...
    public EntsoeServices Entsoe => new(_haContext);
...
public partial class EntsoeServices
{
    private readonly IHaContext _haContext;
    public EntsoeServices(IHaContext haContext)
    {
        _haContext = haContext;
    }

    ///<summary>Request prices for a specified range from entso-e</summary>
    public void GetEnergyPrices(EntsoeGetEnergyPricesParameters data)
    {
        _haContext.CallService("entsoe", "get_energy_prices", null, data);
    }
    ...
    public void GetEnergyPrices(object configEntry, object? start = null, object? end = null)
    {
        _haContext.CallService("entsoe", "get_energy_prices", null, new EntsoeGetEnergyPricesParameters { ConfigEntry = configEntry, Start = start, End = end });
    }

    ///<summary>Request prices for a specified range from entso-e</summary>
    public Task<JsonElement?> GetEnergyPricesAsync(EntsoeGetEnergyPricesParameters data)
    {
        return _haContext.CallServiceWithResponseAsync("entsoe", "get_energy_prices", null, data);
    }
    ...
    ///<param name="start">Specifies the date and time from which to retrieve prices. Defaults to today if omitted. eg: 2023-01-01 00:00:00</param>
    ///<param name="end">Specifies the date and time until which to retrieve prices. Defaults to today if omitted. eg: 2023-01-01 00:00:00</param>
    public Task<JsonElement?> GetEnergyPricesAsync(object configEntry, object? start = null, object? end = null)
    {
        return _haContext.CallServiceWithResponseAsync("entsoe", "get_energy_prices", null, new EntsoeGetEnergyPricesParameters { ConfigEntry = configEntry, Start = start, End = end });
    }
}

public partial record EntsoeGetEnergyPricesParameters
{
...
public partial class LinkplayServices
{
    ...
    ///<summary>Play the preset number on the device.</summary>
    ///<param name="target">The target for this service call</param>
    ...
    ///<summary>Play the preset number on the device.</summary>
    ///<param name="presetNumber">The preset number on the device to play. eg: 1</param>
...
{
    ///<summary>The preset number on the device to play. eg: 1</summary>
...
public partial class TibberServices
{
    ...
    ///<summary>Get hourly energy prices from Tibber</summary>
